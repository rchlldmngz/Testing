$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "REDGINA: A decade and eight.",

            // Event start date
            start: new Date('August 05, 2023 17:00'),

            // You can also choose to set an end time
            // If an end time is set, this will take precedence over duration
            end: new Date('August 05, 2023 21:00'),

            // Event Address
            address: 'AsriBali Countryside Garden',

            // Event Description
            description: "I can't wait to see you there."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $.post('https://script.google.com/macros/s/AKfycby7CTaxMvnNRzNOmf8trYAmTIaM12Zuso4DwHxk7k8BMo6x8eZdm_jIqhEtJsUdQ_9YoA/exec', data)
            .done(function (data) {
                console.log(data);
